...
class AdminArticleWidget extends StatefulWidget {
  final String articleId;
  final ArticleModel article;
  final String adminName; 

  const AdminArticleWidget(
      {Key? key, required this.articleId, required this.article, required this.adminName,})
      : super(key: key);

  @override
  _AdminArticleWidgetState createState() => _AdminArticleWidgetState();
}

class _AdminArticleWidgetState extends State<AdminArticleWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: Text(widget.adminName, style: TextStyle(fontWeight: FontWeight.bold,color: Colors.deepPurple[900], fontSize: 26)),
      ),
      body: Column(
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    widget.article.fullText ?? widget.article.summary,
